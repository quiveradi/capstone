    ...
    <div class="container">
        ...
        <div class="sidebar">
            <div class="profile">
                ...
                <div class="profile-name">Mary Joyce Figueroa</div>
                <div class="profile-role">LIS Officer</div>
            </div>

            <nav class="nav-menu">
                <a href="#" class="nav-item" onclick="changeContent('section')"> <img src="white document.png" class="nav-logo"> Documents</a>
                <a href="#" class="nav-item" onclick="changeContent('grades')"> <img src="white section.png" class="nav-logo"> Sectioning</a>
            </nav>

            <a href="LIS_login.php" class="logout"> <img src="white logout.png" class="nav-logo">Logout</a>
        </div>
